...
\onehalfspacing
% Evita desbordes (Overfull/Underfull \hbox) por acrónimos en \texttt
% (SVRPBench, RL4CO, EHBG-FACS) que no admiten partición silábica.
...
\begin{table}[ht]
\centering
\caption{Cronograma tentativo de actividades (6 meses)}
\label{tab:cronograma}
\renewcommand{\arraystretch}{1.3}
\setlength{\tabcolsep}{4pt}
\small
\begin{tabular}{>{\bfseries\color{uanlblue}}p{8cm}
                *{6}{>{\centering\arraybackslash}p{1.0cm}}}
\toprule
\rowcolor{uanlblue}
{\color{white}\textbf{Actividad Metodol\'ogica Clave}} &
{\color{white}\small Jun} & {\color{white}\small Jul} &
{\color{white}\small Ago} & {\color{white}\small Sep} &
{\color{white}\small Oct} & {\color{white}\small Nov} \\
\midrule

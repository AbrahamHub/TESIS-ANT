...
@article{Heakl2025SVRP,
  author  = {Heakl, Ahmed and Shaaban, Yahia Salaheldin and Tak{\'a}c, Martin and Lahlou, Salem and Iklassov, Zangir},
  title   = {{SVRPBench}: A Realistic Benchmark for Stochastic Vehicle Routing Problem},
  journal = {arXiv preprint arXiv:2505.21887},
  year    = {2025}
}
@article{Bengio2021Architectures,
  author  = {Bengio, Yoshua and Deleu, Tristan and Hu, Edward J. and Kipf, Thomas and Lahlou, Salem and Jastrzebski, Stanislaw and Jain, Moksh and Precup, Doina},
  title   = {Flow Network Architectures for Generative Flow Networks},
...
@inproceedings{Zhang2025Hybrid,
  author    = {Zhang, Ni and Lee, Seunggeun and Cao, Zhiguang and Park, Jinkyoo and Lahlou, Salem},
  title     = {Hybrid-Balance {GFlowNet} for Solving Vehicle Routing Problems},
  booktitle = {Advances in Neural Information Processing Systems (NeurIPS)},
  year      = {2025}
}
@inproceedings{Kim2024GFACS,
  author    = {Kim, Minsu and Park, Jinkyoo and Lahlou, Salem and Bengio, Yoshua},
...
@article{ENN_GFN_2025,
  author  = {Laajil, Aya and Shtanchaev, Abduragim and Muhammad, Sajan and Moulines, Eric and Lahlou, Salem},
